        ...
        return {
            ...
            link: function (scope, element, attrs, ngModel) {
                ...
                element.on('focus', function () {
                    var viewValue = ngModel.$$rawModelValue;
                    var fraction = angular.element(this).attr('fraction');
                    if (fraction && !isNaN(parseInt(fraction))) {
                        scope.fraction = angular.element(this).attr('fraction');
                    }
                    else {
                        scope.fraction = 2;
                    }
                    ...
                    else if (isNaN(viewValue) || viewValue === '' || viewValue == null) {
                        viewValue = '0.00';
                    }
                    else {
